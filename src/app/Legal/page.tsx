export  default function Legal(){
    return(
        <div className="container mt-5">
            <div className="mt-5">
                <br/>
            <h1 className="mt-5">Privacy Policy for Zimbabwe Services Online</h1>

<h2>1. Introduction</h2>
<p>Welcome to Zimbabwe Services Online. We respect the privacy of our users. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website.</p>
...
<p>This policy is effective as of September 14, 2023.</p>
<br />
<h1>Terms and Conditions for Zimbabwe Services Online</h1>

<h2>1. Introduction</h2>
<p>These Website Standard Terms and Conditions written on this webpage shall manage your use of our website, Zimbabwe Services Online accessible at www.zimbabweservices.com.</p>

<h2>2. Intellectual Property Rights</h2>
<p>Other than the content you own, under these Terms, Zimbabwe Services Online and/or its licensors own all the intellectual property rights and materials contained in this Website.</p>
...
<p>This document was last updated on September 14, 2023.</p>
            </div>
        </div>
    )
}