    ...
    return(
        <div className="container rounded shadow-lg p-3 bg-white text-center " >
            ...
            <form onSubmit={(e:any)=>handleSubmit(e)} >
                ...
                <div>
                    <input type="checkbox" value="true" className="form-check-input me-1" required/><span>By signing up you agree to our <a>Terms and Conditions </a></span>
                </div>
                <div>
                    <button className={genBtn} disabled={disableBtn}>Sign Up</button>
                </div>
                </div>
