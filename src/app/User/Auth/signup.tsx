        ...
        <div className="container rounded shadow-lg p-3 bg-white text-center  " style={{ width: "350px" }}>
            ...
            <form onSubmit={(e: any) => handleSubmit(e)} autoComplete="none">
                <div className="row  d-flex  justify-content-center ">
                    ...
                    <br />
                    <div className="m-3">
                        <input type="checkbox" value="true" className="form-check-input me-1 mb-3" required /><span><small>By signing up you agree to our <a>Terms and Conditions </a></small></span>
                    </div>
